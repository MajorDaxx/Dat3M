...
define dso_local i8* @read(i8* noundef %0) #0 !dbg !42 {
  ...
  br i1 %11, label %13, label %12, !dbg !56

12:                                               ; preds = %1
  br label %14, !dbg !56

13:                                               ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.read, i64 0, i64 0)) #4, !dbg !53
  unreachable, !dbg !53
